<template>
  <el-menu
    ...
    <el-menu-item index="/course-construct">
    ...
    <el-submenu index="8" v-if="this.$store.state.permission">
    ...
    <el-menu-item index="/campus-recruit" v-if="this.$store.state.permission">
