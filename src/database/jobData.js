const jobData = [
  {
    ...
    jobDutyDetails: '1.图像处理、版面理解及OCR识别基础技术研究，算法编写；\n' +
        '2.数字化加工相关的流程、工具软件开发',
    requiredSkillDesc: '1.国家**重点大学硕士以上学历，模式识别、图像处理、计算机、应用数学等相关专业，解决北京户口；\n' +
    ...
    label: ['企业服务', '工具软件', '深度学习', '图片识别', '数据挖掘', '文字识别'],
  ...
  },
  {
    ...
    jobDutyDetails: '1.担任作业帮测试开发工程师，负责大部分产品的功能/接口/自动化/性能/可靠性/安全等专项测试工作。\n' +
        ...
        '4.参与内部工具平台如上线、监控、评测等系统设计维护与开发工作。',
  ...
  },
  {
    ...
    salary: '18k-25k·13薪',
    publishTime: '2021/02/25',
    label: ['电商平台', '营销服务｜咨询', '文化传媒', 'Android'],
    introduce: '消费生活/上市公司',
